...
spring |>
  ...
  mutate(
    Camera = case_when(
      Camera == "1" ~ "Camera 1 (15-degrees)",
      Camera == "2" ~ "Camera 2 (45-degrees)",
      Camera == "3" ~ "Camera 3 (150-degrees)"
    )
  ) |>
